# RATING SCORES CREATED WITH UDACITY
# Program for a consumer rating website.
# The program will take 5 scores, but because highest and lowest scores might be outliers and skew the results,
# we will take the three middle scores out of the five, discarding the highest and lowest.
...
def sum_of_middle_three(score1, score2, score3, score4, score5):
    ...
    result = score1 + score2 + score3 + score4 + score5 - max_score - min_score
    return result
...
def scores_to_rating(score1, score2, score3, score4, score5):
    ...
    average_score = sum_of_middle_three(score1, score2, score3,
                                        score4, score5) / 3
...
print(scores_to_rating(1, 5, 2, 2, 2))
